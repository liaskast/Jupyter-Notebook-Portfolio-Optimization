...
Please find below, a link to a [virtual workspace](https://mybinder.org/v2/gh/liaskast/Jupyter-Notebook-Portfolio-Optimization/master) where the porfolio optimization interface can be launched.
